...
상단의 메타 정보는 "---"로 시작해서 "---"로 끝나는 부분입니다. 이후의 내용은 마크다운과 html, jekyll tag를 이용해서 자유롭게 작성하면됩니다. 위코드에서 {% raw %}{% highlight ruby %}{% endraw %}가 jekyll tag입니다. 이런 테그를 통해 소스코드같은 콘텐트를 쉽게 넣을 수 있습니다.
